...
// //assigning the item in the LOCAL storage
...
// //Assigning the item to SESSION Storage 
// sessionStorage.setItem('nameInput', 'emailInput')
// sessionStorage.setItem('Uma', 'uma@gmail.com')
// console.log(sessionStorage.getItem('Uma'))
// //sessionStorage.removeItem('Uma')

//COOKIES
//document.cookie = 'name=Uma'
